...
{
	/** @var ActiveMapper\DataTypes\Time */
	private $object;

	public function setUp()
	{
		$this->object = new \ActiveMapper\DataTypes\Time('test');
	}
	...
	{
		$this->assertTrue($this->object->validate("08:32:12"));
	}
	...
	{
		$object = new \ActiveMapper\DataTypes\Time('test', TRUE);
		$this->assertTrue($object->validate(NULL));
	}

	public function testSanitizeDate1()
	{
		$data = $this->object->sanitize("08:32:12");
		$this->assertType('DateTime', $data);
		$this->assertEquals(new \DateTime("08:32:12"), $data);
	}

	public function testSanitizeDate2()
	{
		$data = $this->object->sanitize(new \DateTime("08:32:12"));
		$this->assertType('DateTime', $data);
		$this->assertEquals(new \DateTime("08:32:12"), $data);
	}
